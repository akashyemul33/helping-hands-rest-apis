...
public class ValidateAddPlaceMethodTest {
    ...
    private static AddPlaceApi addPlaceApi;

    @BeforeAll
    static void setup() {
        addPlaceApi = new AddPlaceApi(null);
    }
    ...
    void givenEmptyObjThen402() {
        ...
        Response<DhPlace> actualResponse = addPlaceApi.validateAddPlace(null,null, null);
    ...
    void givenEmptyAddedByThen402() {
        ...
        dhPlace.setAddedBy("");
        Response<DhPlace> expectedResponse = new Response<DhPlace>(false, 402, ResponseMsgFactory.getResponseMsg(null, AppConstants.RESPONSEMESSAGE_EMPTY_BODY), new ArrayList<>());
        Response<DhPlace> actualResponse = addPlaceApi.validateAddPlace(null,null, dhPlace);
        assertEquals(expectedResponse.getStatus(), actualResponse.getStatus());
        assertEquals(expectedResponse.getStatusCode(), actualResponse.getStatusCode());
    ...
    void givenPlaceAvailaibilityWithout24into7_emptyOrInvalidOpeningTime_Then402() {
        ...
        Response<DhPlace> actualResponse2 = addPlaceApi.validateAddPlace(null,null, dhPlace);
