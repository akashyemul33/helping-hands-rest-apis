...
public class UploadPlaceImagesTest {
    ...
    void givenEmptyImagesThenErrorResponse() throws ServerSideException {
        ...
        Response<DhPlace> actualResponse = imageService.uploadPlaceImages(null, null, AppConstants.BUSINESS_PLACE, null, null, AppConstants.SCHEMA_VERSION);
        ...
        Response<DhPlace> actualResponse2 = imageService.uploadPlaceImages(null, null, AppConstants.BUSINESS_PLACE, null, new MultipartFile[]{emptyFile}, AppConstants.SCHEMA_VERSION);
    ...
    void givenEmptyPlaceTypeThenErrorResponse() throws ServerSideException {
        Response<DhPlace> expectedUserResponse = new Response<>(false, 402, ResponseMsgFactory.getResponseMsg(null, AppConstants.RESPONSEMESSAGE_EMPTY_BODY), new ArrayList<>());
        MultipartFile emptyFile = new MockMultipartFile("abc", (byte[]) null);
        Response<DhPlace> actualResponse = imageService.uploadPlaceImages(null, null, null, null, new MultipartFile[]{emptyFile}, AppConstants.SCHEMA_VERSION);
        assertEquals(expectedUserResponse.getStatus(), actualResponse.getStatus());
        assertEquals(expectedUserResponse.getStatusCode(), actualResponse.getStatusCode());
    }
    ...
    void givenEmptyUserIdThenErrorResponse() throws ServerSideException {
        Response<DhPlace> expectedUserResponse = new Response<>(false, 402, ResponseMsgFactory.getResponseMsg(null, AppConstants.RESPONSEMESSAGE_EMPTY_BODY), new ArrayList<>());
        MultipartFile emptyFile = new MockMultipartFile("abc", (byte[]) null);
        Response<DhPlace> actualResponse = imageService.uploadPlaceImages(null, null, AppConstants.BUSINESS_PLACE, null, new MultipartFile[]{emptyFile}, AppConstants.SCHEMA_VERSION);
        assertEquals(expectedUserResponse.getStatus(), actualResponse.getStatus());
        assertEquals(expectedUserResponse.getStatusCode(), actualResponse.getStatusCode());
    }
