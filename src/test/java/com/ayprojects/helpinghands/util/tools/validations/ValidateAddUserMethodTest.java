...
public class ValidateAddUserMethodTest {
    ...
    void givenEmptyDhUserThen402() {
        ...
        Response<DhUser> actualResponse = Validations.validateAddUser(null, null, userDetailsService, userRepository);
    ...
    void givenEmptyMobileThen402() {
        ...
        Response<DhUser> actualResponse = Validations.validateAddUser(null, dhUser, userDetailsService, userRepository);
        assertEquals(expectedResponse.getStatus(), actualResponse.getStatus());
        assertEquals(expectedResponse.getStatusCode(), actualResponse.getStatusCode());
        assertTrue(expectedResponse.getMessage().equalsIgnoreCase(actualResponse.getMessage()));
        ...
        Response<DhUser> actualResponse2 = Validations.validateAddUser(null, dhUser, userDetailsService, userRepository);
