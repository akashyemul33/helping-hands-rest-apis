...
public class Validations {
    ...
    public static List<String>  findMissingFieldsForRequirements(DhRequirements dhRequirements){
        ...
        if(Utility.isFieldEmpty(dhRequirements.getAddedBy())) missingFieldsList.add(AppConstants.ADDED_BY);
        if(Utility.isFieldEmpty(dhRequirements.getRequirementId())) missingFieldsList.add(AppConstants.REQUIREMENT_ID);
        if(dhRequirements.getAddressDetails()==null)missingFieldsList.add(AppConstants.ADDRESS_DETAILS);
        else {
        ...
        if(dhRequirements.getContactDetails()==null)missingFieldsList.add(AppConstants.CONTACT_DETAILS);
        else{
        ...
        if(Utility.isFieldEmpty(dhRequirements.getRequirementTitle())) missingFieldsList.add(AppConstants.REQ_TITLE);
        if(Utility.isFieldEmpty(dhRequirements.getRequirementDesc())) missingFieldsList.add(AppConstants.REQ_DESC);
        return missingFieldsList;
    }
    ...
    public static List<String>  findMissingFieldsForRatings(DhRatingAndComments dhRatingComments){
        ...
        if(Utility.isFieldEmpty(dhRatingComments.getAddedBy())) missingFieldsList.add(AppConstants.ADDED_BY);
        if(dhRatingComments.getRating()<=0) missingFieldsList.add(AppConstants.RATING);
        if(Utility.isFieldEmpty(dhRatingComments.getContentType())) missingFieldsList.add(AppConstants.CONTENT_TYPE);
        if(Utility.isFieldEmpty(dhRatingComments.getContentId())) missingFieldsList.add(AppConstants.CONTENT_ID);
        return missingFieldsList;
    }
    ...
    public static List<String>  findMissingFieldsForPlaces(DhPlace dhPlace){
        ...
        if(Utility.isFieldEmpty(dhPlace.getPlaceId())) missingFieldsList.add(AppConstants.PLACE_ID);
