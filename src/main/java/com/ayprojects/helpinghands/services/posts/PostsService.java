...
public interface PostsService {
    Response<DhPosts> addPost(Authentication authentication, HttpHeaders httpHeaders, MultipartFile[] postImages, String postBody, String version) throws ServerSideException;
